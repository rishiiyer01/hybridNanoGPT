...
class GPT(nn.Module):
    ...
    def create_blockmasks(self, input_seq: Tensor, sliding_window_num_blocks: Tensor):
        ...
        seq_idx = docs[None, :].to(torch.int32).contiguous()
        ...
        return build_bm(sliding_window_num_blocks), build_bm(sliding_window_num_blocks // 2), seq_idx
    ...
    def forward(self, input_seq: Tensor, target_seq: Tensor, sliding_window_num_blocks: Tensor):
        ...
        long_bm, short_bm,seq_idx = self.create_blockmasks(input_seq, sliding_window_num_blocks)
